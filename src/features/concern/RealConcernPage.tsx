...
const PREVIEW_PAGE: PLPMode = "concern";
...
const CONCERN_BANNER_MAP: Record<string, string> = {
  Acne: "/banners/concern-acne.jpg",
  "Dark Spots": "/banners/concern-dark-spots.jpg",
  Brightening: "/banners/concern-brightening.jpg",
  "Oily Skin": "/banners/concern-oily-skin.jpg",
  "Dry Skin": "/banners/concern-dry-skin.jpg",
  "Sensitive Skin": "/banners/concern-sensitive-skin.jpg",
  Hairfall: "/banners/concern-hairfall.jpg",
  "Dull Skin": "/banners/concern-dull-skin.jpg",
};
...
export default function RealConcernPage() {
...
function MasterPLPPreview({
  ...
  const currentConcernBanner =
    currentConcern !== "All"
      ? CONCERN_BANNER_MAP[currentConcern] || "/banners/default-concern.jpg"
      : CONCERN_BANNER_MAP[presetConcern || "Acne"] || "/banners/default-concern.jpg";
  ...
  const showCategoryControls = true;
  const showBrandControls = true;
  ...
  return (
    <div className="min-h-screen bg-[#f7f7f7] text-slate-900">
      ...
      <section className="mx-auto max-w-[1480px] px-6 py-8">
        ...
        {mode === "brand" ? (
          <div className="mb-8 overflow-hidden rounded-[2rem] border border-[#d5dedf] bg-white shadow-sm">
            <div className="grid gap-0 lg:grid-cols-[1.15fr_0.85fr]">
              <div className="p-8 md:p-10">
                <div className="inline-flex rounded-full bg-[#eef4f4] px-4 py-2 text-xs font-semibold uppercase tracking-[0.16em] text-[#5E7F85]">
                  Brand Focus
                </div>
                <h1 className="mt-5 text-[2rem] font-bold leading-tight text-[#23395b] md:text-[2.5rem]">
                  {brandInfo.title}
                </h1>
                <p className="mt-4 max-w-2xl text-[1.02rem] leading-8 text-[#556b8e]">
                  {brandInfo.description}
                </p>
                <div className="mt-5 text-sm font-semibold uppercase tracking-[0.18em] text-[#6f8f95]">
                  {brandInfo.availableText}
                </div>
                ...
                <div className="mt-6 flex flex-wrap gap-3">
                  {brandInfo.tags.map((tag) => (
                    <span
                      key={tag}
                      className="rounded-full border border-[#d5dedf] bg-[#f8fbfb] px-4 py-2 text-sm font-medium text-[#4d6587]"
                    >
                      {tag}
                    </span>
                  ))}
                ...
                <div className="mt-8 grid gap-4 sm:grid-cols-3">
                  {brandInfo.stats.map((stat) => (
                    <div
                      key={stat.label}
                      className="rounded-[1.2rem] border border-[#dce6e8] bg-[#fbfcfc] p-4"
                    >
                      <div className="text-xs font-semibold uppercase tracking-[0.16em] text-[#7a8ea8]">
                        {stat.label}
                      </div>
                      <div className="mt-2 text-lg font-semibold text-[#23395b]">
                        {stat.value}
                      </div>
                    </div>
                  ))}
              ...
              <div className="bg-[linear-gradient(180deg,#eff5f5_0%,#dfeaea_100%)] p-8 md:p-10">
                <div className="rounded-[1.8rem] border border-white/70 bg-white/70 p-6 backdrop-blur">
                  <div className="text-sm font-semibold uppercase tracking-[0.16em] text-[#6f8f95]">
                    Quick Highlights
                  </div>
                  <div className="mt-5 space-y-4">
                    {brandInfo.highlights.map((item) => (
                      <div
                        key={item.label}
                        className="rounded-[1.1rem] border border-[#d9e4e6] bg-white px-4 py-4"
                      >
                        <div className="text-xs font-semibold uppercase tracking-[0.16em] text-[#7a8ea8]">
                          {item.label}
                        </div>
                        <div className="mt-2 text-base font-semibold text-[#23395b]">
                          {item.value}
                        </div>
                      </div>
                    ))}
